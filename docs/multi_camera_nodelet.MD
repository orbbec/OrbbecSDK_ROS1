...
This section describes how to set up multiple camera Node nodes in the same Nodelet Manager in a ROS 1 environment. Make sure you've already reviewed the [multi_camera.MD](multi_camera.MD)document.
