    ...
    : mNodeHandle(nh), mPrivateNodeHandle(pnh), mReconfigServer(pnh), mDevice(dev)
{
    mSetLaserEnableService =
        mNodeHandle.advertiseService("device/set_laser_enable", &OrbbecDevice::setLaserEnableCallback, this);
    mSetLdpEnableService =
        mNodeHandle.advertiseService("device/set_ldp_enable", &OrbbecDevice::setLdpEnableCallback, this);
    mSetFloorEnableService =
        mNodeHandle.advertiseService("device/set_floor_enable", &OrbbecDevice::setFloorEnableCallback, this);
...
bool OrbbecDevice::setLaserEnableCallback(orbbec_camera::SetLaserEnableRequest& req,
                                          orbbec_camera::SetLaserEnableResponse& res)
{
...
bool OrbbecDevice::setFloorEnableCallback(orbbec_camera::SetFloorEnableRequest& req,
                                          orbbec_camera::SetFloorEnableResponse& res)
{
...
bool OrbbecDevice::setLdpEnableCallback(orbbec_camera::SetLdpEnableRequest& req,
                                        orbbec_camera::SetLdpEnableResponse& res)
{
