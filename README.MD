...
```bash
source ./devel/setup.bash 
roslaunch orbbec_camera gemini2L.launch
```
...
<launch>
    ...
    <arg name="3d_sensor" default="gemini2L"/>
...
`you_device_name_here` is the name of the device you want to create, for example `gemini2L`.
